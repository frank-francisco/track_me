...
class MyCirclePage extends StatefulWidget {
  final String userId;
  MyCirclePage({this.userId});

  @override
  _MyCirclePageState createState() => _MyCirclePageState(userId: userId);
}

class _MyCirclePageState extends State<MyCirclePage> {
  String userId;
  _MyCirclePageState({this.userId});
            ...
            if (snapshot.data.documents.length == 0) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  DocumentSnapshot userInfo = snapshot.data.documents[index];
