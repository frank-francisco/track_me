...
class _SetupCompanyAccountState extends State<SetupCompanyAccount> {
  ...
  createData() {
    ...
    Map<String, dynamic> tasks = {
      ...
      'connection_password': connectingPass,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            filled: true,
                            labelText: 'Reg number/ID',
                            contentPadding: const EdgeInsets.all(0.0),
                            errorStyle: TextStyle(color: Colors.brown),
                          ),
                          onChanged: (val) {
                            setState(() => regNumber = val.trim());
                          },
                          validator: (val) =>
                              val.length < 5 ? ('Enter a valid number') : null,
                        ),
                        SizedBox(
                          height: 20,
                        ),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            filled: true,
                            labelText: 'Connecting password',
                            contentPadding: const EdgeInsets.all(0.0),
                            errorStyle: TextStyle(color: Colors.brown),
                          ),
                          onChanged: (val) {
                            setState(() => connectingPass = val.trim());
                          },
                          validator: (val) => val.length < 8
                              ? ('8 min characters password')
                              : null,
                        ),
                        SizedBox(
                          height: 20,
