...
class PurchasePage extends StatefulWidget {
  ...
  PurchasePage({this.userId, this.packageId});

  @override
  _PurchasePageState createState() =>
      _PurchasePageState(userId: userId, packageId: packageId);
}

class _PurchasePageState extends State<PurchasePage> {
  String userId;
  String packageId;
  _PurchasePageState({this.userId, this.packageId});
